...
/**
 * Code for Calendar. This class provides the structure for accessing room based
 * on the date that they are selected. This class is used to get, set, and
...
public class Calendar {
	 ...
	 * @param day
	 *            (int) (Equals actual -1) Ranges from 0 - 30, 0 - 29, or 0 - 27
	 *            depending on the Calendar month. Day to be unbooked.
	 * @param room
	 *            (int) Ranges from 101 to 152. Room selected to be unbooked.
	 ...
	 * 
	 * @param month
	 *            (int) Equals actual -1) Ranges from 0 - 11. Month selected to get
	 *            the price of the room.
	 * @param day
	 *            (int) (Equals actual -1) Ranges from 0 - 30, 0 - 29, or 0 - 27
	 *            depending on the Calendar month. Day selected to get the price of
	 *            the room.
	 * @param room
	 *            (int) Ranges from 101 to 152. Room selected to get price of room.
